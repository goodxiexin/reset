...
BACKUP_CHANNEL_LINK = "https://t.meScammerFuk"
ADMIN_IDS = [5994393899]  # Replace with your admin user ID(s)
DATABASE_NAME = "bot_users.db"

# Initialize bot
bot = telebot.TeleBot(os.getenv("BOT_TOKEN") or "8305209090:AAHNCv4GqUPSHoUoK5T1UtxG-FBu0WEmO28")
